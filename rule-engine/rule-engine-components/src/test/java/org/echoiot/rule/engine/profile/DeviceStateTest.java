...
public class DeviceStateTest {
    ...
    public void whenAttributeIsDeleted_thenUnneededAlarmRulesAreNotReevaluated() throws Exception {
        ...
        @NotNull DeviceProfileAlarm alarmConfig = createAlarmConfigWithBoolAttrCondition("enabled", false);
        @NotNull DeviceId deviceId = new DeviceId(UUID.randomUUID());
        @NotNull DeviceState deviceState = createDeviceState(deviceId, alarmConfig);

        @NotNull TbMsg attributeUpdateMsg = TbMsg.newMsg(SessionMsgType.POST_ATTRIBUTES_REQUEST.name(),
                                                         deviceId, new TbMsgMetaData(), "{ \"enabled\": false }");

        deviceState.process(ctx, attributeUpdateMsg);

        @NotNull ArgumentCaptor<TbMsg> resultMsgCaptor = ArgumentCaptor.forClass(TbMsg.class);
        ...
        @NotNull String deletedAttributes = "{ \"attributes\": [ \"other\" ] }";
    ...
    public void whenDeletingClearedAlarm_thenNoError() throws Exception {
        ...
        @NotNull TbMsg alarmDeleteNotification = TbMsg.newMsg(DataConstants.ALARM_DELETE, deviceId, new TbMsgMetaData(), JacksonUtil.toString(alarm));
        assertDoesNotThrow(() -> {
    ...
    private DeviceState createDeviceState(DeviceId deviceId, DeviceProfileAlarm... alarmConfigs) {
        ...
        @NotNull ProfileState profileState = new ProfileState(deviceProfile);
    ...
    private DeviceProfileAlarm createAlarmConfigWithBoolAttrCondition(String key, boolean value) {
        ...
        @NotNull AlarmConditionFilter condition = new AlarmConditionFilter();
        ...
        @NotNull BooleanFilterPredicate predicate = new BooleanFilterPredicate();
        ...
        @NotNull DeviceProfileAlarm alarmConfig = new DeviceProfileAlarm();

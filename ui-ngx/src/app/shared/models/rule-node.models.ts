...
export const ruleChainNodeClazz = 'org.echoiot.rule.engine.flow.TbRuleChainInputNode';
export const outputNodeClazz = 'org.echoiot.rule.engine.flow.TbRuleChainOutputNode';

const ruleNodeClazzHelpLinkMap = {
  'org.echoiot.rule.engine.filter.TbCheckRelationNode': 'ruleNodeCheckRelation',
  'org.echoiot.rule.engine.filter.TbCheckMessageNode': 'ruleNodeCheckExistenceFields',
  'org.echoiot.rule.engine.geo.TbGpsGeofencingFilterNode': 'ruleNodeGpsGeofencingFilter',
  'org.echoiot.rule.engine.filter.TbJsFilterNode': 'ruleNodeJsFilter',
  'org.echoiot.rule.engine.filter.TbJsSwitchNode': 'ruleNodeJsSwitch',
  'org.echoiot.rule.engine.filter.TbAssetTypeSwitchNode': 'ruleNodeAssetProfileSwitch',
  'org.echoiot.rule.engine.filter.TbDeviceTypeSwitchNode': 'ruleNodeDeviceProfileSwitch',
  'org.echoiot.rule.engine.filter.TbCheckAlarmStatusNode': 'ruleNodeCheckAlarmStatus',
  'org.echoiot.rule.engine.filter.TbMsgTypeFilterNode': 'ruleNodeMessageTypeFilter',
  'org.echoiot.rule.engine.filter.TbMsgTypeSwitchNode': 'ruleNodeMessageTypeSwitch',
  'org.echoiot.rule.engine.filter.TbOriginatorTypeFilterNode': 'ruleNodeOriginatorTypeFilter',
  'org.echoiot.rule.engine.filter.TbOriginatorTypeSwitchNode': 'ruleNodeOriginatorTypeSwitch',
  'org.echoiot.rule.engine.metadata.TbGetAttributesNode': 'ruleNodeOriginatorAttributes',
  'org.echoiot.rule.engine.metadata.TbGetOriginatorFieldsNode': 'ruleNodeOriginatorFields',
  'org.echoiot.rule.engine.metadata.TbGetTelemetryNode': 'ruleNodeOriginatorTelemetry',
  'org.echoiot.rule.engine.metadata.TbGetCustomerAttributeNode': 'ruleNodeCustomerAttributes',
  'org.echoiot.rule.engine.metadata.TbGetCustomerDetailsNode': 'ruleNodeCustomerDetails',
  'org.echoiot.rule.engine.metadata.TbGetDeviceAttrNode': 'ruleNodeDeviceAttributes',
  'org.echoiot.rule.engine.metadata.TbGetRelatedAttributeNode': 'ruleNodeRelatedAttributes',
  'org.echoiot.rule.engine.metadata.TbGetTenantAttributeNode': 'ruleNodeTenantAttributes',
  'org.echoiot.rule.engine.metadata.TbGetTenantDetailsNode': 'ruleNodeTenantDetails',
  'org.echoiot.rule.engine.transform.TbChangeOriginatorNode': 'ruleNodeChangeOriginator',
  'org.echoiot.rule.engine.transform.TbTransformMsgNode': 'ruleNodeTransformMsg',
  'org.echoiot.rule.engine.mail.TbMsgToEmailNode': 'ruleNodeMsgToEmail',
  'org.echoiot.rule.engine.action.TbAssignToCustomerNode': 'ruleNodeAssignToCustomer',
  'org.echoiot.rule.engine.action.TbUnassignFromCustomerNode': 'ruleNodeUnassignFromCustomer',
  'org.echoiot.rule.engine.action.TbClearAlarmNode': 'ruleNodeClearAlarm',
  'org.echoiot.rule.engine.action.TbCreateAlarmNode': 'ruleNodeCreateAlarm',
  'org.echoiot.rule.engine.action.TbCreateRelationNode': 'ruleNodeCreateRelation',
  'org.echoiot.rule.engine.action.TbDeleteRelationNode': 'ruleNodeDeleteRelation',
  'org.echoiot.rule.engine.delay.TbMsgDelayNode': 'ruleNodeMsgDelay',
  'org.echoiot.rule.engine.debug.TbMsgGeneratorNode': 'ruleNodeMsgGenerator',
  'org.echoiot.rule.engine.geo.TbGpsGeofencingActionNode': 'ruleNodeGpsGeofencingEvents',
  'org.echoiot.rule.engine.action.TbLogNode': 'ruleNodeLog',
  'org.echoiot.rule.engine.rpc.TbSendRPCReplyNode': 'ruleNodeRpcCallReply',
  'org.echoiot.rule.engine.rpc.TbSendRPCRequestNode': 'ruleNodeRpcCallRequest',
  'org.echoiot.rule.engine.telemetry.TbMsgAttributesNode': 'ruleNodeSaveAttributes',
  'org.echoiot.rule.engine.telemetry.TbMsgTimeseriesNode': 'ruleNodeSaveTimeseries',
  'org.echoiot.rule.engine.action.TbSaveToCustomCassandraTableNode': 'ruleNodeSaveToCustomTable',
  'org.echoiot.rule.engine.aws.sns.TbSnsNode': 'ruleNodeAwsSns',
  'org.echoiot.rule.engine.aws.sqs.TbSqsNode': 'ruleNodeAwsSqs',
  'org.echoiot.rule.engine.kafka.TbKafkaNode': 'ruleNodeKafka',
  'org.echoiot.rule.engine.mqtt.TbMqttNode': 'ruleNodeMqtt',
  'org.echoiot.rule.engine.mqtt.azure.TbAzureIotHubNode': 'ruleNodeAzureIotHub',
  'org.echoiot.rule.engine.rabbitmq.TbRabbitMqNode': 'ruleNodeRabbitMq',
  'org.echoiot.rule.engine.rest.TbRestApiCallNode': 'ruleNodeRestApiCall',
  'org.echoiot.rule.engine.mail.TbSendEmailNode': 'ruleNodeSendEmail',
  'org.echoiot.rule.engine.sms.TbSendSmsNode': 'ruleNodeSendSms',
  'org.echoiot.rule.engine.edge.TbMsgPushToCloudNode': 'ruleNodePushToCloud',
  'org.echoiot.rule.engine.edge.TbMsgPushToEdgeNode': 'ruleNodePushToEdge',
  'org.echoiot.rule.engine.flow.TbRuleChainInputNode': 'ruleNodeRuleChain',
  'org.echoiot.rule.engine.flow.TbRuleChainOutputNode': 'ruleNodeOutputNode',
  'org.echoiot.rule.engine.math.TbMathNode': 'ruleNodeMath',
};

...
export const timewindowCompletion: TbEditorCompletion = {
  ...
  meta: 'property',
  type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/time/time.models.ts#L80">Timewindow</a>',
  children: {
    displayValue: {
    ...
    realtime: {
      ...
      meta: 'property',
      type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/time/time.models.ts#L39">IntervalWindow</a>',
      children: {
        interval: {
    ...
    history: {
      ...
      meta: 'property',
      type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/time/time.models.ts#L49">HistoryWindow</a>',
      children: {
        historyType: {
        ...
        fixedTimewindow: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/time/time.models.ts#L44">FixedWindow</a>',
          children: {
            startTimeMs: {
    ...
    aggregation: {
      ...
      meta: 'property',
      type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/time/time.models.ts#L74">Aggregation</a>',
      children: {
        interval: {
        ...
        type: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/time/time.models.ts#L54">AggregationType</a>'
        },
        limit: {
...
export const widgetContextCompletions: TbEditorCompletions = {
  ctx: {
    ...
    meta: 'object',
    type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/modules/home/models/widget-component.models.ts#L83">WidgetContext</a>',
    children: {
      ...{
        $container: {
        ...
        $scope: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/modules/home/models/widget-component.models.ts#L274">IDynamicWidgetComponent</a>'
        },
        width: {
        ...
        widgetConfig: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L341">WidgetConfig</a>',
          children: {
            title: {
            ...
            legendConfig: {
              ...
              meta: 'property',
              type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L198">LegendConfig</a>',
              children: {
                position: {
                  description: 'Legend position. Possible values: <code>\'top\', \'bottom\', \'left\', \'right\'</code>',
                  meta: 'property',
                  type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L182">LegendPosition</a>',
                },
                direction: {
                  description: 'Legend direction. Possible values: <code>\'column\', \'row\'</code>',
                  meta: 'property',
                  type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L170">LegendDirection</a>',
                },
                showMin: {
            ...
            alarmSource: {
              ...
              meta: 'property',
              type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L250">Datasource</a>'
            },
            alarmSearchStatus: {
              description: 'Configured default alarm search status for alarm widget type.',
              meta: 'property',
              type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/alarm.models.ts#L41">AlarmSearchStatus</a>'
            },
            ...
            datasources: {
              ...
              meta: 'property',
              type: 'Array&lt;<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L250">Datasource</a>&gt;'
            }
          }
        },
        settings: {
          description: 'Widget settings containing widget specific properties according to the defined <a href="https://echoiot.io/docs/user-guide/contribution/widgets-development/#settings-schema-section">settings json schema</a>',
          meta: 'property',
          type: 'object'
        },
        datasources: {
        ...
        data: {
          ...
          meta: 'property',
          type: 'Array&lt;<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L275">DatasourceData</a>&gt;'
        },
        timeWindow: {
          description: 'Current widget timewindow (applicable for timeseries widgets).',
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/time/time.models.ts#L104">WidgetTimewindow</a>'
        },
        units: {
          description: 'Optional property defining units text of values displayed by widget. Useful for simple widgets like cards or gauges.',
          meta: 'property',
        ...
        currentUser: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/user.model.ts#L45">AuthUser</a>',
          children: {
            sub: {
            ...
            authority: {
              ...
              meta: 'property',
              type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/authority.enum.ts#L17">Authority</a>'
            }
          }
        },
        hideTitlePanel: {
        ...
        defaultSubscription: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/core/api/widget-api.models.ts#L220">IWidgetSubscription</a>'
        },
        timewindowFunctions: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/core/api/widget-api.models.ts#L45">TimewindowFunctions</a>',
          children: {
            onUpdateTimewindow: {
        ...
        controlApi: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/core/api/widget-api.models.ts#L58">RpcApi</a>',
          children: {
            sendOneWayCommand: {
        ...
        actionsApi: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/core/api/widget-api.models.ts#L67">WidgetActionsApi</a>',
          children: {
            getActionDescriptors: {
              ...
              return: {
                ...
                type: 'Array&lt;<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L323">WidgetActionDescriptor</a>&gt;'
              }
            },
            handleWidgetAction: {
              ...
              args: [
                ...
                },
                {
                  ...
                  type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/shared/models/widget.models.ts#L323">WidgetActionDescriptor</a>'
                },
                {
                  name: 'entityId',
        ...
        stateController: {
          ...
          meta: 'property',
          type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/core/api/widget-api.models.ts#L121">IStateController</a>',
          children: {
            openState: {
              ...
              args: [
                ...
                },
                {
                  ...
                  type: '<a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/core/api/widget-api.models.ts#L111">StateParams</a>',
                  optional: true
                },
                {
              ...
              args: [
                {
                  ...
                  type: 'Array <a href="https://github.com/echoiot/echoiot/blob/13e6b10b7ab830e64d31b99614a9d95a1a25928a/ui-ngx/src/app/core/api/widget-api.models.ts#L140">StateObject</a>',
                },
                {
                  name: 'openRightLayout',
                  description: 'An optional boolean argument to force open right dashboard layout if present in mobile view mode.',

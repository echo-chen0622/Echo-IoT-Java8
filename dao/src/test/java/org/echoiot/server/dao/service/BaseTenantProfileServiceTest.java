...
public abstract class BaseTenantProfileServiceTest extends AbstractServiceTest {
    ...
    public void testSaveTenantProfile() {
        TenantProfile tenantProfile = createTenantProfile("Tenant Profile");
    ...
    public void testFindDefaultTenantProfile() {
        TenantProfile tenantProfile = createTenantProfile("Default Tenant Profile");
    ...
    public void testSetDefaultTenantProfile() {
        TenantProfile tenantProfile1 = createTenantProfile("Tenant Profile 1");
        TenantProfile tenantProfile2 = createTenantProfile("Tenant Profile 2");
    ...
    public void testSaveTenantProfileWithSameName() {
        TenantProfile tenantProfile = createTenantProfile("Tenant Profile");
        tenantProfileService.saveTenantProfile(TenantId.SYS_TENANT_ID, tenantProfile);
        TenantProfile tenantProfile2 = createTenantProfile("Tenant Profile");
    ...
    public void testFindTenantProfiles() {
        ...
        for (int i = 0; i < 28; i++) {
            TenantProfile tenantProfile = createTenantProfile("Tenant Profile" + i);

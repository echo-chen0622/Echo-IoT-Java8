...
public abstract class BaseOAuth2ServiceTest extends AbstractServiceTest {
        ...
        OAuth2Info oAuth2Info = new OAuth2Info(true, Lists.newArrayList(
                OAuth2ParamsInfo.builder()
                        ...
                        .clientRegistrations(Lists.newArrayList(
                                ...
                                validRegistrationInfo("Facebook", List.of(PlatformType.IOS)),
    ...
    private OAuth2RegistrationInfo validRegistrationInfo(@Nullable String label, @Nullable List<PlatformType> platforms) {
    ...
    private OAuth2MobileInfo validMobileInfo(String pkgName, @Nullable String appSecret) {

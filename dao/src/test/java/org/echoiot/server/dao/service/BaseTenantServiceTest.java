...
public abstract class BaseTenantServiceTest extends AbstractServiceTest {
    ...
    public void testGettingTenantAddingItToCache() {
        ...
        verify(tenantDao, Mockito.times(1)).findById(eq(savedTenant.getId()), ArgumentMatchers.eq(savedTenant.getId().getId()));
    ...
    public void testExistsTenantAddingResultToCache() {
        ...
        verify(tenantDao, Mockito.times(1)).existsById(eq(savedTenant.getId()), ArgumentMatchers.eq(savedTenant.getId().getId()));

package org.echoiot.server.dao.model.sqlts.ts;
...
public final class TsKvEntity extends AbstractTsKvEntity {
    ...
    public TsKvEntity(@Nullable Long longValue, @Nullable Double doubleValue, Long longCountValue, Long doubleCountValue, String aggType, Long aggValuesLastTs) {
        super(aggValuesLastTs);

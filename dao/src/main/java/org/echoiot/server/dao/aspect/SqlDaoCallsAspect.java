...
public class SqlDaoCallsAspect {
    ...
    public void printStats() {
        @NotNull List<DbCallStatsSnapshot> snapshots = snapshot();
        ...
        try {
            if (log.isTraceEnabled()) {
                ...
                @NotNull Map<String, Map<TenantId, MethodCallStatsSnapshot>> byMethodStats = new HashMap<>();
                for (@NotNull DbCallStatsSnapshot snapshot : snapshots) {
    ...
    private void logSnapshot(@NotNull DbCallStatsSnapshot snapshot, int limit, @NotNull Comparator<MethodCallStatsSnapshot> methodStatsComparator, String sortingKey, @NotNull Consumer<String> logger) {
    ...
    private void logTopNTenants(@NotNull List<DbCallStatsSnapshot> snapshots, Comparator<DbCallStatsSnapshot> comparator,
    ...
    public Object handleSqlCall(@NotNull ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    private void reportFailedMethodExecution(TenantId tenantId, String method, long startTime, @org.jetbrains.annotations.Nullable Throwable t, @NotNull ProceedingJoinPoint joinPoint) {
        if (t != null) {
    ...
    TenantId getTenantId(@NotNull MethodSignature signature, String methodName, @org.jetbrains.annotations.Nullable Object[] args) {

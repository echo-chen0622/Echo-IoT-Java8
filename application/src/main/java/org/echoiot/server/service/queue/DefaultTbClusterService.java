...
public class DefaultTbClusterService implements TbClusterService {
    ...
    @Override
    public void pushMsgToRuleEngine(@Nullable TenantId tenantId, EntityId entityId, TbMsg tbMsg, TbQueueCallback callback) {
    ...
    private TbMsg transformMsg(TbMsg tbMsg, @Nullable RuleChainId targetRuleChainId, @Nullable String targetQueueName) {
    ...
    @Override
    public void onDeviceUpdated(Device device, @Nullable Device old, boolean notifyEdge) {
    ...
    @Override
    public void sendNotificationMsgToEdge(TenantId tenantId, @Nullable EdgeId edgeId, @Nullable EntityId entityId, @Nullable String body, @Nullable EdgeEventType type, EdgeEventActionType action) {
        if (!edgesEnabled) {
            return;
        }
        if (type == null) {

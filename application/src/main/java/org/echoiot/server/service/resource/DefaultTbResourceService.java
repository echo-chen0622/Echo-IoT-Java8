...
import org.echoiot.server.common.data.lwm2m.LwM2mInstance;
import org.echoiot.server.common.data.lwm2m.LwM2mObject;
import org.echoiot.server.common.data.lwm2m.LwM2mResourceObserve;
import org.echoiot.server.common.data.page.PageData;
import org.echoiot.server.common.data.page.PageLink;
import org.echoiot.server.dao.device.DeviceServiceImpl;
        ...
        if (ResourceType.LWM2M_MODEL.equals(resource.getResourceType())) {
            try {
                ...
                if (!objectModels.isEmpty()) {
                    ...
                    resource.setSearchText(resourceKey + LwM2mConstants.LWM2M_SEPARATOR_SEARCH_TEXT + name);
                } else {

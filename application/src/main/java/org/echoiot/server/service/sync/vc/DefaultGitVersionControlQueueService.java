...
import org.echoiot.server.service.sync.vc.data.ClearRepositoryGitRequest;
import org.echoiot.server.service.sync.vc.data.CommitGitRequest;
import org.echoiot.server.service.sync.vc.data.EntitiesContentGitRequest;
import org.echoiot.server.service.sync.vc.data.EntityContentGitRequest;
import org.echoiot.server.service.sync.vc.data.ListBranchesGitRequest;
import org.echoiot.server.service.sync.vc.data.ListEntitiesGitRequest;
import org.echoiot.server.service.sync.vc.data.ListVersionsGitRequest;
import org.echoiot.server.service.sync.vc.data.PendingGitRequest;
import org.echoiot.server.service.sync.vc.data.VersionsDiffGitRequest;
import org.echoiot.server.service.sync.vc.data.VoidGitRequest;

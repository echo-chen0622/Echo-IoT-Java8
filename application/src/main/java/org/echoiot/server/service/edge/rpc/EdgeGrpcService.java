...
import org.echoiot.server.gen.edge.v1.EdgeRpcServiceGrpc;
...
public class EdgeGrpcService extends EdgeRpcServiceGrpc.EdgeRpcServiceImplBase implements EdgeRpcService {
    ...
    public void init() {
        ...
        this.edgeEventProcessingExecutorService = Executors.newScheduledThreadPool(schedulerPoolSize, EchoiotThreadFactory.forName("edge-event-check-scheduler"));
        this.sendDownlinkExecutorService = Executors.newScheduledThreadPool(sendSchedulerPoolSize, EchoiotThreadFactory.forName("edge-send-scheduler"));
        this.executorService = Executors.newSingleThreadScheduledExecutor(EchoiotThreadFactory.forName("edge-service"));

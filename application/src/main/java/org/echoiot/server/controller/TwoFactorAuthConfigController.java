...
public class TwoFactorAuthConfigController extends BaseController {
    ...
    @ApiOperation(value = "Generate 2FA account config (generateTwoFaAccountConfig)",
            notes = "Generate new 2FA account config template for specified provider type. " + ControllerConstants.NEW_LINE +
    ...
    @ApiOperation(value = "Submit 2FA account config (submitTwoFaAccountConfig)",
            notes = "Submit 2FA account config to prepare for a future verification. " +
                    ...
                    "sense for a chosen 2FA provider. This code is needed to then verify and save the account config." + ControllerConstants.NEW_LINE +
                    ...
                    "}\n```" + ControllerConstants.NEW_LINE +
                    "For TOTP this method does nothing." + ControllerConstants.NEW_LINE +
    ...
    @ApiOperation(value = "Verify and save 2FA account config (verifyAndSaveTwoFaAccountConfig)",
            notes = "Checks the verification code for submitted config, and if it is correct, saves the provided account config. " + ControllerConstants.NEW_LINE +
    ...
    @ApiOperation(value = "Save platform 2FA settings (savePlatformTwoFaSettings)",
            notes = "Save 2FA settings for platform. The settings have following properties:\n" +
                    ...
                    "- `verificationCodeLifetime` - the same as for SMS." + ControllerConstants.NEW_LINE +

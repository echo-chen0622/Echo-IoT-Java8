...
public class OAuth2Controller extends BaseController {
    ...
    @ApiOperation(value = "Get current OAuth2 settings (getCurrentOAuth2Info)", notes = ControllerConstants.SYSTEM_AUTHORITY_PARAGRAPH)
    ...
    @ApiOperation(value = "Save OAuth2 settings (saveOAuth2Info)", notes = ControllerConstants.SYSTEM_AUTHORITY_PARAGRAPH)
    @PreAuthorize("hasAnyAuthority('SYS_ADMIN')")
    ...
    @ApiOperation(value = "Get OAuth2 log in processing URL (getLoginProcessingUrl)", notes = "Returns the URL enclosed in " +
                                                                                              ...
                                                                                              "as 'SECURITY_OAUTH2_LOGIN_PROCESSING_URL' env variable. By default it is '/login/oauth2/code/'" + ControllerConstants.SYSTEM_AUTHORITY_PARAGRAPH)
    @PreAuthorize("hasAnyAuthority('SYS_ADMIN')")

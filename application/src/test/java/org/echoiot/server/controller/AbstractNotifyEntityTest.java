...
public abstract class AbstractNotifyEntityTest extends AbstractWebTest {
    ...
    private void testLogEntityActionNever(EntityId entityId, @Nullable HasName entity) {
    ...
    protected void testBroadcastEntityStateChangeEventTime(EntityId entityId, @Nullable TenantId tenantId, int cntTime) {
    ...
    @Nullable
    private <T> T extractParameter(Class<T> clazz, @Nullable Object additionalInfo) {

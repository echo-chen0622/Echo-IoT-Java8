...
public class DefaultClusterVersionControlService extends TbApplicationEventListener<PartitionChangeEvent> implements ClusterVersionControlService {
    ...
    private void reply(VersionControlRequestCtx ctx, Optional<Exception> e, @org.jetbrains.annotations.Nullable Function<VersionControlResponseMsg.Builder, VersionControlResponseMsg.Builder> enrichFunction) {
    ...
    private String getRelativePath(EntityType entityType, @org.jetbrains.annotations.Nullable String entityId) {

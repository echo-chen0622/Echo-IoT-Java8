...
import static org.echoiot.server.transport.lwm2m.server.uplink.LwM2mTypeServer.BOOTSTRAP;
...
public class LwM2MBootstrapSecurityStore implements BootstrapSecurityStore {
    ...
    @Nullable
    public SecurityInfo addValueToStore(@Nullable TbLwM2MSecurityInfo store, String endpoint) {
        /* add value to store  from BootstrapJson */
        @Nullable SecurityInfo securityInfo = null;

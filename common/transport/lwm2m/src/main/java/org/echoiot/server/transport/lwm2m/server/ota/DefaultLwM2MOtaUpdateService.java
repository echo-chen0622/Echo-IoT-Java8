...
import org.echoiot.server.transport.lwm2m.server.ota.firmware.FirmwareDeliveryMethod;
...
import org.echoiot.server.transport.lwm2m.server.ota.firmware.LwM2MFirmwareUpdateStrategy;
...
public class DefaultLwM2MOtaUpdateService extends LwM2MExecutorAwareService implements LwM2MOtaUpdateService {
    ...
    public boolean isOtaDownloading(LwM2mClient client) {
        ...
        if (swInfo != null && (OtaPackageUpdateStatus.DOWNLOADING.equals(swInfo.getStatus()))) {
            return true;
        }

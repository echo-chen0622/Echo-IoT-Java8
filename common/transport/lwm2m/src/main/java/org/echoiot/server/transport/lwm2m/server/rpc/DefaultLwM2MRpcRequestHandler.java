...
import org.echoiot.server.transport.lwm2m.server.downlink.composite.TbLwM2MReadCompositeCallback;
import org.echoiot.server.transport.lwm2m.server.downlink.composite.TbLwM2MReadCompositeRequest;
import org.echoiot.server.transport.lwm2m.server.downlink.composite.TbLwM2MWriteResponseCompositeCallback;
import org.echoiot.server.transport.lwm2m.server.rpc.composite.RpcReadCompositeRequest;
import org.echoiot.server.transport.lwm2m.server.rpc.composite.RpcReadResponseCompositeCallback;
...
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MCancelAllObserveCallback;
...
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MCreateRequest;
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MCreateResponseCallback;
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MDeleteCallback;
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MDeleteRequest;
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MDiscoverAllRequest;
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MDiscoverCallback;
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MDiscoverRequest;
...
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MObserveAllRequest;
...
import org.echoiot.server.transport.lwm2m.server.downlink.TbLwM2MWriteUpdateRequest;
        ...
        try {
            ...
            try {
                if (operationType.isHasObjectId()) {
                    ...
                    @Nullable ContentFormat contentFormatComposite = this.getCompositeContentFormat(client);

...
public class DefaultLwM2mDownlinkMsgHandler extends LwM2MExecutorAwareService implements LwM2mDownlinkMsgHandler {
    ...
    private static <T> void addAttribute(List<Attribute> attributes, String attributeName, @Nullable T value, @Nullable Predicate<T> filter, @Nullable Function<T, ?> converter) {

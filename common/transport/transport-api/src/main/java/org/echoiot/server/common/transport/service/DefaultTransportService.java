...
public class DefaultTransportService implements TransportService {
    ...
    @Override
    public void log(@Nullable TransportProtos.SessionInfoProto sessionInfo, String msg) {
    ...
    private boolean checkLimits(TransportProtos.SessionInfoProto sessionInfo, Object msg, @Nullable TransportServiceCallback<?> callback, int dataPoints) {
        if (log.isTraceEnabled()) {
            log.trace("[{}] Processing msg: {}", toSessionId(sessionInfo), msg);
        }
    ...
    protected void sendToDeviceActor(TransportProtos.SessionInfoProto sessionInfo, TransportToDeviceActorMsg toDeviceActorMsg, @Nullable TransportServiceCallback<Void> callback) {
